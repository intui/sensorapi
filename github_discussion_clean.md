# GitHub Discussion Proposal: Advanced Time Series Analytics
...
**Labels:** `enhancement`, `timescaledb`, `analytics`, `time-series`, `graphql`
...
Based on our [Heat Pump PRD](docs/HeatPump_Page_PRD.md):
